...
Autoaim::Autoaim ()  {
//    trt_module_ = new TRTModule(model_file_);
 ...
 * @return false 识别失败
 */
bool Autoaim::run(TaskData &src, VisionData &data, TRTModule &model){
    auto time_start = std::chrono::steady_clock::now();
    flip(src.img,src.img,0);
    flip(src.img,src.img,1);
    vector<Armor> armors;
...
//        cout << "Center_2D:  "<<armor.center2d<<endl;
